...
<head>
  ...
  <link href="{{ asset('public/css/w3.css') }}" type="text/css" rel="stylesheet" media="screen,projection"/>
  <link href="{{ asset('public/plugins/materialize/css/materialize.css') }}" type="text/css" rel="stylesheet" media="screen,projection"/>
  <link href="{{ asset('public/plugins/materialize/css/style.css') }}" type="text/css" rel="stylesheet" media="screen,projection"/>
  <link href="{{ asset('public/css/home.css') }}" type="text/css" rel="stylesheet" media="screen,projection"/>
  ...
  <!-- Facebook Pixel Code -->
    ...
    fbq('init', '114390439150734'); // Insert your pixel ID here.
    fbq('track', 'PageView');
    </script>
    <noscript><img height="1" width="1" style="display:none"
    src="https://www.facebook.com/tr?id=114390439150734&ev=PageView&noscript=1"
    /></noscript>
  <!-- DO NOT MODIFY -->
